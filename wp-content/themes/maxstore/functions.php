...
function maxstore_setup() {
  ...
  add_image_size( 'maxstore-widget', 640, 280, true );
...
////////////////////////////////////////////////////////////////////
  	...
  	function maxstore_cart_link() {
  		?>	
  			<a class="cart-contents text-right" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php _e( 'View your shopping cart', 'maxstore' ); ?>">
  				<i class="fa fa-shopping-cart"><span class="count"><?php echo WC()->cart->get_cart_contents_count();?></span></i><span class="amount-title"><?php echo _e( 'Cart ','maxstore' ); ?></span><span class="amount-cart"><?php echo wp_kses_data( WC()->cart->get_cart_subtotal() ); ?></span> 
  			</a>
  		<?php
  	}
  }
  ...
  if ( ! function_exists( 'maxstore_header_cart' ) ) {
  	function maxstore_header_cart() {
  		?>
  		<div class="header-cart text-right col-sm-3 col-xs-6">
